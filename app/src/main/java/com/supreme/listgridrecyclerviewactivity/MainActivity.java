...
import com.supreme.listgridrecyclerviewactivity.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewButton.setOnClickListener(v -> {
            Intent intent = new Intent(MainActivity.this,com.supreme.listgridrecyclerviewactivity.ListViewActivity.class);
            intent.putStringArrayListExtra("dataList", dataList);
            startActivity(intent);
        });

        gridViewButton.setOnClickListener(v -> {
            Intent intent = new Intent(MainActivity.this, com.supreme.listgridrecyclerviewactivity.GridViewActivity.class);
            intent.putStringArrayListExtra("dataList", dataList);
            startActivity(intent);
        });

        recyclerViewButton.setOnClickListener(v -> {
            Intent intent = new Intent(MainActivity.this, com.supreme.listgridrecyclerviewactivity.RecyclerViewActivity.class);
            intent.putStringArrayListExtra("dataList", dataList);
            startActivity(intent);
        });
    }
